...
router.get('/profile', isLoggedin, function (req, res, next) {
  User.find(function (err, image) {
    ...
    res.render('user/profile', {userImage:userImage,email:email,firstName:firstName, lastName:lastName,password:password, layout:false});
  })
...
router.get('/profile/settings', isLoggedin, function (req, res, next) {
  User.find(function (err, image) {
    ...
    var firstName = req.user.fname;
    var lastName = req.user.lname;
      res.render('user/settings', {userImage:userImage,firstName:firstName,lastName:lastName, layout:false});
    })
